...
---
{
	...
	orderTypeId: if(["UBE", "GH", "DD", "PM"] contains cardType and !(isEmpty(vars.oderType))) vars.orderType else getOrderTypeIDforMicros(cardType),
	tenderObjectNum: getTenderMediaObjectNumberforMicros(cardType),
